          ...
          <div className="absolute right-0 flex items-center space-x-3 mr-12">
            <div className="flex items-right md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
              ...
              {isCheckoutDrawerOpen && (
                <div id="drawer-right-example" className={`fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform ${isCheckoutDrawerOpen ? 'translate-x-0' : 'translate-x-full'} bg-white w-80 dark:bg-gray-800`} tabIndex="-1" aria-labelledby="drawer-right-label">
