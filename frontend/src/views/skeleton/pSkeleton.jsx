  ...
  return (
    <div className='pt-24'>
        <div className="grid grid-cols-2 md:grid-cols-3 md:p-12 gap-8">
            <div role="status" className="max-w-xl p-4 rounded shadow animate-pulse md:p-6">
                <div className="flex items-center justify-center h-[36rem] mb-4 bg-zinc-300 rounded dark:bg-zinc-700">
                    <svg
                    className="w-10 h-10 text-zinc-200 dark:text-zinc-600"
                    aria-hidden="true"
